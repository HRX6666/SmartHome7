...
public class StepSeekBar extends View {
    ...
    private void initConfig(Context context, AttributeSet attrs) {
        ...
        mTextColorSelected  = typeArr.getColor(R.styleable.StepSeekbar_textColorSelected,Color.BLACK);
        mSeekbarColorNormal = typeArr.getColor(R.styleable.StepSeekbar_seekbarColorNormal, getResources().getColor(R.color.darkhui));
        mSeekbarColorSelected  = typeArr.getColor(R.styleable.StepSeekbar_seekbarColorSelected,getResources().getColor(R.color.white1));
